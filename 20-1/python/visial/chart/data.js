(function() {
    ...
    window.NUM_YEAR_TOTAL = [9776, 8918, 9443, 9166, 9610, 9858, 9863, 10049, 9773, 9662, 6940]
    window.NUM_YEAR_CN = [929, 900, 1221, 1198, 1541, 1798, 3117, 2963, 2659, 2226, 2377]
    window.NUM_YEAR_GAT =  [207, 161, 223, 216, 227, 263, 234, 227, 251, 275, 198]
    window.NUM_YEAR_IND = [273, 229, 278, 281, 339, 313, 253, 240, 296, 496, 205]
    window.NUM_YEAR_USA = [3070, 2353, 2590, 2704, 2716, 2676, 2282, 2388, 2388, 2431, 1975]
    window.NUM_YEAR_KOR = [198, 167, 224, 241, 313, 335, 290, 332, 276, 289, 158]
    window.NUM_YEAR_JAP = [895, 958, 1064, 1184, 1142, 1172, 1033, 1042, 889, 909, 440]
